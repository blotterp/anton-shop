...
if (isset($_GET['source'])) {
    $source_site = 'anton-shop-1';  // Название домена на Webflow без окончания webflow.io
    ...
    if (in_array($source_url['host'], ['webflow-converter.ru', 'test.webflow-converter.ru'])  && $source_file_parts[0] === $source_site) {
